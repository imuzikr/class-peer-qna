...
export function getCurrentUser() {
  ...
  // Google Workspace 계정: 성(familyName) = 학번, 이름(givenName) = 실명
  // const profile = u.providerData[0];
  // return { uid: u.uid, displayName: u.displayName,
  //          role: claims.role ?? "student",
  //          realName: profile?.givenName ?? u.displayName,
  //          studentId: profile?.familyName ?? null,
  //          emoji: "🙂" };

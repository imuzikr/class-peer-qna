...
// -------------------------------------------------------------
// 본문을 읽기 전에 표지·책날개·제목·목차·머리말·그림처럼 본문을 둘러싼
// '곁텍스트'만 훑어보며 책의 내용을 미리 짐작해 보는 독서 전략입니다.
// 영어 첫 글자를 모으면 CATAPULT 이지만, 이 활동에서는 참고문헌을 다루는
// L(Look at the reference)을 빼고 일곱 항목만 씁니다.
//

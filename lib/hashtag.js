...
// 뽑습니다. 태그마다 **그 낱말이 쓰인 원문 문장**을 옮겨 적고, **그 문장으로
// 알 수 있는 것**을 한두 문장으로 씁니다. 끝으로 태그를 엮어 요약문을
// 씁니다. 입력한 것은 폼 아래에서 곧바로 학술 보고서 모양으로 짜여 보입니다
...
// 한 칸이 다 찼나 — 태그 · 원문 문장 · 알 수 있는 것 셋 모두.

...
// 만들기'는 여기(원본)에 한 장을 만들고, 반에서 쓸 때 '이 반에서 시작하기'가
...
// '이 반에서 시작하기'(startStudyTemplateInClass)를 한 번 더 누릅니다.
export async function addStudyTemplate(
  user,
  { title, description = "", keywords = [], activityType = "individual", activities = [] }
) {
...
// [교사] 원본을 이 반에서 시작하기 — 이 반에 복사본 한 장을 만듭니다.
// -------------------------------------------------------------
...
// [교사] 원본 고치기 — 지금은 활동 목록만 부릅니다(아래 syncTemplateActivities).
...
// -------------------------------------------------------------
// 원본을 고치는 화면이 따로 없어, 활동은 늘 반 복사본에서(수업 편집의 활동

...
// 날짜·시각 순수 함수는 lib/dates.js로 옮겼습니다. 여기서도 쓰고, 예전처럼
// "@/lib/store"에서 가져가던 자리도 그대로 돌도록 같은 이름으로 다시 내보냅니다.
import { toDate, todayDateKey, formatTime, formatClockMs, formatStampMs } from "./dates";
export { toDate, todayDateKey, formatTime, formatClockMs, formatStampMs };

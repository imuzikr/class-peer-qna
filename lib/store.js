...
// 개인 활동(paratext·raft)은 모둠 대신 학생 1명당 문서 1개(entries/{uid})를
// 씁니다. 담기는 answers의 키만 다를 뿐 저장 위치와 규칙은 같습니다.
export const BOOK_ACTIVITY_TYPES = ["consonant", "paratext", "raft"];
export const BOOK_SOLO_TYPES = ["paratext", "raft"];

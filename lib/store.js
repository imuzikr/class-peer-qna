...
// ─── 닿소리 진행률 ──────────────────────────────────────────
// [교사] 활동 하나의 반 평균 진행률 — '한 사람이 14칸 중 몇 칸을 채웠나'.
//
// 세는 단위는 낱말이 아니라 **칸**입니다. 한 칸에 낱말을 셋 넣어도 그 칸은
// 하나로 셉니다(13칸에 낱말 14개면 13칸 달성). 낱말 수로 세면 한 칸에 몰아
// 넣은 학생이 골고루 채운 학생보다 앞서 보입니다.
//
// 분모는 그 활동에 배정된 학생 전원입니다 — 한 칸도 안 채운 학생도 0으로
// 들어갑니다. 그러지 않으면 두 명만 참여한 반이 100%로 보입니다.
//
...
async function readConsonantProgress(actId) {
  ...
  return {
    ...
    // 화면에서 평균을 내도록 합계만 넘깁니다(칸 수 14는 화면 쪽 상수).

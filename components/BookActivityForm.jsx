...
//  · 여섯 개의 해시태그 — 학생마다 다른 글을 읽으므로 주제어를 받지 않고,
...
const TYPES = [
  ...
  { key: "hashtag", label: "여섯 개의 해시태그", desc: "글을 읽고 해시태그를 찾아 원문과 생각을 쓰고, 한 사람씩 슬라이드로 띄워 나눕니다", defaultTitle: "여섯 개의 해시태그" },
];
...
export default function BookActivityForm({
  ...
  // '여섯 개의 해시태그'의 안내 문구 — 학생 화면 맨 위에 한 줄로 섭니다
        ...
        {isHashtag && (
          <label className="book-field">
            ...
            <em className="book-help">
              학생은 먼저 찾은 해시태그(최대 여섯 개)를 적고, 태그마다 원문 문장과 생각을 씁니다.

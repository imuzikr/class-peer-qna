...
export default function ProjectLinkOptions({
  ...
  return (
    <div className="project-links">
      <label className="project-link-row">
        <input type="checkbox" checked={kwOn} onChange={(e) => onKwOn(e.target.checked)} />
      ...
      <label className={`project-link-row${isGroup ? " disabled" : ""}`}>
        <input
          type="checkbox"
          checked={pyOn && !isGroup}
          disabled={isGroup}
          onChange={(e) => onPyOn(e.target.checked)}
        />
        <span className="project-link-text">
          <strong>
